...
namespace UniRxExtensions.Tests
{
    ...
    [TestFixture]
    internal class IObservable_SubscribeWithStateWithoutEvent_Test
    {
        ...
        internal class TestsFor1State
        {
            ...
            public void Test_OnNext()
            {
                ...
                TestStream.Make(Unit.Default)
                    .SubscribeWithStateWithoutEvent(
                        State1,
                        s1 =>
                        {
                            Assert.False(onNext);
        ...
        internal class TestsFor2States
        {
            ...
            public void Test_OnNext()
            {
                ...
                TestStream.Make(Unit.Default)
                    .SubscribeWithState2WithoutEvent(
                        State1,
                        State2,
                        (s1, s2) =>
                        {
        ...
        internal class TestsFor3States
        {
            ...
            public void Test_OnNext()
            {
                ...
                TestStream.Make(Unit.Default)
                    .SubscribeWithState3WithoutEvent(
                        State1,
                        State2,
                        State3,
                        (s1, s2, s3) =>
